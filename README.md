...
## About
This project uses most of Schlarpc's code with new export methods added, a different UI, and few other small things. I want to stress that this would not be possible without him. All I did was port it into a wordpress plugin for convenience. You can import this into a wordpress page by using [f3ds-rof] in a shortcode block.

## 🔗 Original Code

Access the original code at: **https://github.com/schlarpc/rof-gui**
...
- `src/signal-processing.js` - Signal processing utilities
- `src/visualizer.js` - Plotly-based visualization engine
- `templates/view.php` - Plugin frontend template
- `f3ds-rof-tool.php` - Main WordPress plugin file
